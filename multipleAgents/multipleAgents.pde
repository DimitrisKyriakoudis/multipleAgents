...
//    panMsg.add(pop.agents.get(i).pos[0]);
//    densMsg.add(pop.agents.get(i).pos[1]);
//    indMsg.add(pop.agents.get(i).pos[2]);
//    ratMsg.add(pop.agents.get(i).pos[3]);
//    durMsg.add(pop.agents.get(i).pos[4]);
//    ampMsg.add(pop.agents.get(i).pos[5]);
//    freqMsg.add(pop.agents.get(i).pos[6]);
//  }
